...
use Botble\Location\Repositories\Caches\CityAreaCacheDecorator;
...
class LocationServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind(CityAreaInterface::class,function () {
            return new CityAreaCacheDecorator(new CityAreaRepository(new CityArea));
        });
