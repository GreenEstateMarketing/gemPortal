        ...
        <div class="">
            <div class="row full-with-row">
                ...
                <div class="col-md-9 mb-3 col-xl-10 pt-5 pr-5 sidebar-inner-pages">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <a href="/account/properties?filter_table_id=plugins-real-estate-properties&class=Botble%5CRealEstate%5CTables%5CAccountPropertyTable&filter_columns%5B%5D=re_properties.moderation_status&filter_operators%5B%5D=%3D&filter_values%5B%5D=approved" class="text-decoration-none">
                        ...
                        <div class="col-md-4">
                            <a href="/account/properties?filter_table_id=plugins-real-estate-properties&class=Botble%5CRealEstate%5CTables%5CAccountPropertyTable&filter_columns%5B%5D=re_properties.moderation_status&filter_operators%5B%5D=%3D&filter_values%5B%5D=pending" class="text-decoration-none">
                                <div class="agent-primary-text">
                        ...
                        <div class="col-md-4">
                            <a href="/account/properties?filter_table_id=plugins-real-estate-properties&class=Botble%5CRealEstate%5CTables%5CAccountPropertyTable&filter_columns%5B%5D=re_properties.moderation_status&filter_operators%5B%5D=%3D&filter_values%5B%5D=rejected" class="text-decoration-none">
                                <div class="agent-primary-text">
                                    <div class="br2 pa3 bg-white mb3 card-hover p-4"
                                         style="box-shadow: 0 1px 1px #ccc;">
                                        <div class="media-body">
