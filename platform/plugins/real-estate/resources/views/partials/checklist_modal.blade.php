        ...
        <div class="modal-content">
            ...
            <div class="modal-body align-items-center">
                <div class="checkbox-list d-flex align-items-center pr-3">
                    ...
                    <button type="button" class="btn btn-gray btn-circle btn-agent ml-4 mr-4"
                ...
                <div class="row">
                    ...
                    <div class="modal-footer">
                        <button class="btn btn-info" type="button" id="verify_checklist"
                            class="btn btn-info next-step">Update Checklist</button>
                ...
                <div class="agents mt-4" style="display: none">
                    ...
                    dropdown-toggle" type="button"
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton" id="dropdown-menu-checklist"
                    ...
                    <div class="row pt-4 agent-detail-admin d-none">
                        ...
                        <div class="col-md-10">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="float-right d-flex"><span class="phone-icon"><i class="fa fa-phone"
                                                aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;&nbsp;</span> <span
                                            class="label-grey" id="agent_no_admin"> &emsp;</span></div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col label-grey" id="agent_email_admin"></div>
                            </div>
                            <div class="row">
                                <div class="col label-grey" id="agent_desc_admin"></div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="modal-footer">
                                <button class="btn btn-info" type="button" id="assign_checklist"
                                    class="btn btn-info next-step">Assign</button>
