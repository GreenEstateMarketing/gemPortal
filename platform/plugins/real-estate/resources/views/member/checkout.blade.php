        ...
        <div class="container">
            ...
            <div class="row mt-4 m-4">
                ...
                <div class="col-md-3 pr-0">
                    <input type="submit" id="btnDiscount" value="Apply" class="form-control btnDiscount  btn btn-primary" />
                </div>
            ...
            <!-- (-%) $voucher->data->get('discount_percent')-->
                <div class="row mt-1 mr-4">
                    ...
                    <label>Discount (-%{{session('discount_percent')}}): {{$package->currency->symbol}}{{session('discount')}}</label>
                    </div>
                </div>
            @else
                    <div class="row mt-1 mr-4 discount-detial d-none">
                        <div class="offset-md-9 col-md-3 text-right pr-0">
                            <label>Discount (-%<span id="discount_per"></span>): {{$package->currency->symbol}} <span id="discount_price"></span></label>
                        </div>
                    </div>
            @endif
            ...
            <div class="row mt-1 mr-4">
                <div class="offset-md-9 col-md-3 text-right pr-0">
                    <label><b>TOTAL PRICE: {{$package->currency->symbol}} <span id="total_price">{{$package->price}}</span></b></label>
                </div>
            </div>
