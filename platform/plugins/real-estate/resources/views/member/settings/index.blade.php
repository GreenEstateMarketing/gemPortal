            ...
            <div class="main-dashboard-form">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 order-lg-0">
                        ...
                        @endif
                        <form action="{{ route('public.member.post.settings') }}" id="setting-form" method="POST" enctype="multipart/form-data">
                        @csrf
                        <!-- Name -->
                            <div class="form-group">
                                <label for="first_name">{{ trans('plugins/real-estate::dashboard.full_name') }}</label>
                            ...
                            <!-- Phone -->
                            <div class="form-group">
                                <label for="phone">{{ trans('plugins/real-estate::dashboard.mobile_no') }}</label>
                                <input type="number" class="form-control" name="mobile_no" id="mobile_no" required value="{{ old('mobile_no') ?? $user->mobile_no }}">
                            </div>
...
@push('scripts')
  ...
  {!! JsValidator::formRequest(\Botble\RealEstate\Http\Requests\MemberSettingRequest::class); !!}
