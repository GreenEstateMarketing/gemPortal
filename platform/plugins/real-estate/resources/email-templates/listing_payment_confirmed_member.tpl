            ...
            <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff; border-radius: 12px; overflow: hidden;">
                <tr>
                    <td style="background-color:#1a1d24; padding: 32px 40px;">
                        <span style="display:inline-block; color:#e0a63e; font-size: 12px; font-weight: 700; letter-spacing: 1.5px; text-transform: uppercase; border: 1px solid #e0a63e; border-radius: 999px; padding: 4px 12px;">PAYMENT CONFIRMED</span>
                        <h1 style="color:#ffffff; font-size: 21px; margin: 16px 0 0; font-family: Georgia, 'Times New Roman', serif; font-weight: normal;">Congratulations - your property is now listed!</h1>
                    </td>
                </tr>
                <tr>
                    <td style="padding: 36px 40px 8px;">
                        ...
                        <p style="font-size:15px; color:#333333; line-height:1.7; margin: 0 0 28px;">
                            Your listing payment for <strong>{{ property_title }}</strong> has gone through &mdash; 1 credit was deducted from your account, and your property is now live and fully listed on GEM Listing. Thank you for completing the process!
                        </p>
