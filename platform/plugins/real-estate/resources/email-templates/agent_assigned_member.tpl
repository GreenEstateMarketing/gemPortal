            ...
            <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff; border-radius: 12px; overflow: hidden;">
                <tr>
                    <td style="background-color:#1a1d24; padding: 32px 40px;">
                        ...
                        <h1 style="color:#ffffff; font-size: 21px; margin: 16px 0 0; font-family: Georgia, 'Times New Roman', serif; font-weight: normal;">An agent has been assigned to your property</h1>
                    </td>
                </tr>
                <tr>
                    <td style="padding: 36px 40px 8px;">
                        ...
                        <p style="font-size:15px; color:#333333; line-height:1.7; margin: 0 0 28px;">
                            <strong>{{ agent_name }}</strong> has been assigned as the agent for your property, <strong>{{ property_title }}</strong>. They'll be in touch to help verify and move your listing forward.
                        </p>
