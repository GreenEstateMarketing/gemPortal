            ...
            <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff; border-radius: 12px; overflow: hidden;">
                <tr>
                    <td style="background-color:#1a1d24; padding: 32px 40px;">
                        ...
                        <h1 style="color:#ffffff; font-size: 21px; margin: 16px 0 0; font-family: Georgia, 'Times New Roman', serif; font-weight: normal;">Your property details have been updated</h1>
                    </td>
                </tr>
                <tr>
                    <td style="padding: 36px 40px 8px;">
                        ...
                        <p style="font-size:15px; color:#333333; line-height:1.7; margin: 0 0 28px;">
                            The details for your property, <strong>{{ property_title }}</strong>, have been updated through the listing wizard. Take a look to make sure everything looks right.
                        </p>
