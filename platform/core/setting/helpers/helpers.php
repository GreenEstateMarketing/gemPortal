...
if (!function_exists('getSqFeet')) {
    function getSqFeet($val, $type)
    {
        switch ($type) {
            case 'ft2':
                return $val;
                break;
            case 'm2':
                return setting('real_estate_square_meter_to_sq_ft') * $val;
                break;
            case 'marla':
                return setting('real_estate_marla_to_square_ft') * $val;
                break;
            case 'yards':
                return setting('real_estate_yards_to_sq_ft') * $val;
                break;
            case 'kanal':
                return setting('real_estate_kanal_to_sq_ft') * $val;
                break;
