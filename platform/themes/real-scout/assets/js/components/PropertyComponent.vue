        ...
        <div class="col-sm-4 col-md-3 colm10" v-for="item in data" :key="item.id" v-if="!isLoading && data.length"
            ...
            <div class="hourseitem">
                ...
                <div class="info">
                    ...
                    <div class="room-info pt-3"><b class="pr-2 bed-no">{{ item.number_bedroom }}</b><i
                            class="fa fa-bed fa-2x bed-icon" aria-hidden="true"></i><b class="pr-2 bath-no">{{
                            item.number_bathroom }}</b><i class="fa fa-bath fa-2x bath-icon" aria-hidden="true"></i><i
                            class="fa fa-building  square-icon" aria-hidden="true"></i><b class="pr-2 square-no">{{
                            item.square_text }}</b></div>
