(function ($) {
  ...
  $(document).ready(function () {
    ...
    $(document).on("click", ".add-to-wishlist", function (e) {
      ...
      if (property_id != null && property_id != 0 && property_id != undefined) {
        ...
        if (
          ...
          $(`.add-to-wishlist[data-id=${property_id}] i`)
    ...
    $(document).on("click", ".remove-from-wishlist", function (e) {
      ...
      if (property_id != null && property_id != 0 && property_id != undefined) {
        ...
        if (index != -1) {
          ...
          showSuccess(__("Removed from wishlist successfully!"));
          $(`.wishlist-page .item[data-id=${property_id}]`)
            .closest("div")
            .remove();
        }
      }
    ...
    function setWishListCount() {
      ...
      if (
        wishListCookies != null &&
        wishListCookies != undefined &&
        !!wishListCookies
      ) {
        ...
        if (countWishlist > 0) {
          ...
          $.each(arrList, function (key, value) {
            if (value != null) {
              $(document)
                .find(`.add-to-wishlist[data-id=${value.id}] i`)
                .addClass("fas fa-heart");
            }
          });
        }
