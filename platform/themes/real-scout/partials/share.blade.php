    ...
    <div id="socialHolder" class="col-md-6">
        ...
        <div id="socialShare" class="btn-group share-group">
            ...
            <ul class="dropdown-menu socials_links">
                <li>
                    <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(url()->current()) }}&title={{ urlencode($description) }}"
                        target="_blank" title="{{ __('Share on Facebook') }}">
                        <img src="{{ Theme::asset()->url('images/fb.png')  }}" class="m-1 p-1 social_icons"
                            alt="Image"></a>
                </li>
                <li>
                    <a href="https://www.linkedin.com/shareArticle?mini=true&url={{ urlencode(url()->current()) }}&summary={{ rawurldecode($description) }}&source=Linkedin"
                        title="{{ __('Share on Linkedin') }}" target="_blank">
                        <img class="m-1 p-1 social_icons" src="{{ Theme::asset()->url('images/in.png')  }}"
                            alt="Image"></a>
                </li>
                <li>
                    <a href="https://x.com/intent/post?url={{ urlencode(url()->current()) }}&text={{ urlencode($description) }}"
                        target="_blank" title="{{ __('Share on Twitter') }}">
                        <img class="m-1 p-1 social_icons" src="{{ Theme::asset()->url('images/x.png')  }}"
                            alt="Image"></a>
                </li>
                <li>

                    <a href="https://web.whatsapp.com/send?url={{ urlencode(url()->current() . '/') }}&text={{ urlencode(url()->current() . '/') }}"
                        target="_blank" title="{{ __('Share on Whatsapp') }}">
                        <img class="m-1 p-1 social_icons" src="{{ Theme::asset()->url('images/whatsapp.png')  }}"
                            alt="Image"></a>
                </li>
            </ul>
        </div>
