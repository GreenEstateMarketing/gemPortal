...
<div class="side-navigation">
    ...
    <div class="side-content">
        ...
        <p>By aiming to take the life quality to an upper level with the whole realized Projects, GEM continues to be
...
@if (url()->current() == route('public.single') || ($page && $page->template === 'homepage'))
    <header class="slider">
        <div class="slider-container">
            <div class="topsearch">
                @if (theme_option('home_banner_description'))<h1
                    class="text-center text-white mb-4 banner-text-description">{{ theme_option('home_banner_description') }}</h1>@endif
                            ...
                            <div class="keyword-input">
                                ...
                                <select class="form-control" id='city_id' name="city_id">
                                    ...
                                    @foreach(app(\Botble\Location\Repositories\Interfaces\CityInterface::class)->allBy(['status' => \Botble\Base\Enums\BaseStatusEnum::PUBLISHED], ['state', 'country'],['cities.name', 'cities.state_id', 'cities.country_id', 'cities.id']) as $city)
                                        <option
                                            value={{$city->id}}>{{$city->name . ($city->state->name ? ' (' . $city->state->name . ')' : '')}}</option>
                                    @endforeach
                                </select>
                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-control">
                                                    ...
                                                    <span class="dropdown-toggle" id="propertydropdownMenuLink" style="cursor: pointer;">Category Type</span>
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="row price-from-to">
                                                            ...
                                                            <div class="col-md-4"><span
                                                                    class="max_price_text">Any</span></div>
                                                        </div>
                                                        ...
                                                        <div class="dropdown-menu" style="padding:10px;width:100%">
                                                            ...
                                                            <button type="button" class="btn btn-reset-price" style="margin: 10px; height: 35px !important;">
                                                                Reset
                                                            </button>
                                                ...
                                                <div class="price-dropdown">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="row price-from-to">
                                                            ...
                                                            <div class="col-md-2" style="margin-left: 9px;margin-right: -15px;">to</div>
                                                            <div class="col-md-4"><span
                                                                    class="max_price_text">Any</span></div>
                                                        </div>
...
{{--                                                                class="currency">(Square feet)</span><strong--}}
{{--                                                                class="caret"></strong>--}}
...
{{--                                                                            <li class="unit-li-item" data-value="{{ $unit }}">{{ $unit }}</li>--}}
{{--                                                                        @endforeach--}}
                                                                        ...
                                                                        @foreach(app(\Botble\RealEstate\Repositories\Interfaces\CategoryInterface::class)->pluck('re_categories.name', 're_categories.id',array('parent_id'=>$categoryId)) as $subcategoryId => $subcategoryName)
                                                                            <div
                                                                                ...
                                                                                <li class="category-li-item"
                                                                                    ...
                                                                                    data-id="{{$subcategoryId}}">{{$subcategoryName}}</li>
                                                                            </div>
                                                                        @endforeach
                                                                    </div>
                                                                </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <!--<div class="select--arrow">
                                                ...
                                                <div class="form-control">
                                                    <input type="hidden" name="category_id" class="category_id">
                                                    <span id="projectdropdownMenuLink" class="dropdown-toggle">Category Type</span>
                                                    <span style="display: flex" class="category_id_text">Home</span>
                                                ...
                                                <div class="price-dropdown">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu" style="padding:10px;width:100%">
                                                            ...
                                                            <button type="button"
                                                                    class="btn btn-primary btn-reset-price" style="margin: 10px; height: 35px !important;">Reset
                                                            </button>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary btn-sm" style="height: 29px;" data-dismiss="modal">Close</button>
