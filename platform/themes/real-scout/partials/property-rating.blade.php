                    ...
                    <div class="comment-box text-center">
                        <form id="rateform" method="post">
                            <div class="form-group">
                                ...
                                <strong id="agent_name"></strong>

                            </div>
                        <h4>Add a comment</h4>
                            <input type="hidden" id="property_id" name="property_id" />
                            <input type="hidden" id="agent_id" name="agent_id" />
                        <div class="rating"> <input type="radio" name="rating" value="5" id="5"><label for="5">☆</label> <input type="radio" name="rating" value="4" id="4"><label for="4">☆</label> <input type="radio" name="rating" value="3" id="3"><label for="3">☆</label> <input type="radio" name="rating" value="2" id="2"><label for="2">☆</label> <input type="radio" name="rating" value="1" id="1"><label class="one" for="1">☆</label> </div>
                        <div class="comment-area"> <textarea class="form-control" id="comment" name="comment" placeholder="what is your view?" rows="4"></textarea> </div>
                        <div class="text-center mt-4"> <button id="rate_send" class="btn btn-success   send px-5" type="button">Rate Now</button> </div>
                        </form>
                    </div>
                </div>
            </div>
                ...
                <form method="POST">
                    <div class="block max-w-3xl px-1 py-2 mx-auto">
                        ...
                        <div class="my-5">
                            ...
                            @enderror
                            <textarea  name="description" class="block w-full px-4 py-3 border border-2 rounded-lg focus:border-blue-500 focus:outline-none" placeholder="Comment.."></textarea>
                        </div>
                    </div>
                    <div class="block">
