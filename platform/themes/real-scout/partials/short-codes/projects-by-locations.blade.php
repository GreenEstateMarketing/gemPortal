    ...
    <div class="container-fluid w90">
        ...
        <div class="padtop70">
            <div class="areahome">
                <div class="row">
                    <div class="col-12">
                        <div class="property-head text-center">

                            <h4><span>Projects</span>  By Locations</h4>
                    ...
                    <div class="owl-carousel" id="project-city-slides">
                        @foreach($cities as $city)
                            <div class="item itemarea">
                                <a href="{{ route('public.project-by-city', $city->id) }}"><img src="{{ RvMedia::getImageUrl($city->image, 'small', false, RvMedia::getDefaultImage()) }}"
                                                                                                  alt="{{ $city->name }}">
                                </a>
                            </div>
                        @endforeach
