        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                <figure>
                    ...
                    <!-- end pattern-bg -->
                    <div class="holder" data-stellar-ratio="1.10"> <img src="{{ Theme::asset()->url('images/side-image01.jpg')  }}" alt="Image"></div>
                    <!-- end holder -->
                </figure>
            </div>
            <!-- end col-6 -->
            <div class="col-lg-6 wow fadeInUp">
                <div class="content-box">
                    ...
                    <p>100% refundable, safe and secure investments

                        Our criteria to choose best investment projects</p>
                    <a href="#" class="link">SEE OUR PROJECTS <i class="fas fa-caret-right"></i></a></div>
        </div>
                <!-- end content-box -->
            </div>
            <!-- edn col-6 -->
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col wow fadeInUp" data-wow-delay="0s">
                <figure> <img src="{{ Theme::asset()->url('images/icon-benefits01.png')  }}" alt="Image"> <b></b> </figure>
            ...
            <div class="col wow fadeInUp" data-wow-delay="0.05s">
                <figure> <img src="{{ Theme::asset()->url('images/icon-benefits02.png')  }}" alt="Image"> <b></b> </figure>
            ...
            <div class="col wow fadeInUp" data-wow-delay="0.10s">
                <figure> <img src="{{ Theme::asset()->url('images/icon-benefits03.png')  }}" alt="Image"> <b></b> </figure>
            ...
            <div class="col wow fadeInUp" data-wow-delay="0.15s">
                <figure> <img src="{{ Theme::asset()->url('images/icon-benefits04.png')  }}" alt="Image"> <b></b> </figure>
                <h6>Spaces in Islamabad</h6>
            ...
            <div class="col wow fadeInUp" data-wow-delay="0.20s">
                <figure> <img src="{{ Theme::asset()->url('images/icon-benefits05.png')  }}" alt="Image"> <b></b> </figure>
                <h6>Spaces in Islamabad</h6>
            ...
            <div class="col-lg-7">
                <div class="row inner">
                    <div class="col-md-4 wow fadeInUp" data-wow-delay="0s">
                        <figure data-stellar-ratio="1.07"> <a href="{{ Theme::asset()->url('images/gallery-thumb01.jpg')  }}" data-fancybox><img src="{{ Theme::asset()->url('images/gallery-thumb01.jpeg')  }}" alt="Image"></a> </figure>
                    </div>
                    <!-- end col-4 -->
                    <div class="col-md-4 wow fadeInUp" data-wow-delay="0.05s">
                        <figure data-stellar-ratio="1.15"> <a href="{{ Theme::asset()->url('images/gallery-thumb02.jpg')  }}" data-fancybox><img src="{{ Theme::asset()->url('images/gallery-thumb02.jpeg')  }}" alt="Image"></a> </figure>
                    </div>
                    <!-- end col-4 -->
                    <div class="col-md-4 wow fadeInUp" data-wow-delay="0.10s">
                        <figure data-stellar-ratio="1.04"> <a href="{{ Theme::asset()->url('images/gallery-thumb03.jpg')  }}" data-fancybox><img src="{{ Theme::asset()->url('images/gallery-thumb03.jpeg')  }}" alt="Image"></a> </figure>
                    </div>
                    <!-- end col-4 -->
                </div>
                <!-- end row -->
        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                <figure>
                    ...
                    <!-- end pattern-bg -->
                    <div class="holder" data-stellar-ratio="1.07"> <img src="{{ Theme::asset()->url('images/side-image02.jpg')  }}" alt="Image"></div>
                    <!-- end holder -->
                </figure>
            </div>
            <!-- end col-6 -->
            <div class="col-lg-6 wow fadeInUp">
                <div class="content-box">
                    ...
                    <p>Golf Floras - Your gateway to ultimate luxury! Located at Bahria Town (Garden City) Islamabad.</p>
