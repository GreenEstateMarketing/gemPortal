                                ...
                                <div class="col-md-11">
                                    <div class="row">
                                        <div class="col-md-6 pr-1">
                                            <button style="height: 35px;" type="button" class="btn d-block w-100 label-primary type_sale" data-id="sale" data-type-name="BUY" style="Width:10rem" value="buy">
                                                <span class="tick-selected"><i class="fas fa-check"></i></span>   BUY
                                            </button>
                                        </div>
                                        <div class="col-md-6 pl-1">
                                            <button style="height: 35px;" type="button" class="btn d-block w-100 label-secondary type_rent" data-id="rent" data-type-name="RENT" style="Width:100%" value="rent">RENT
                                            </button>
                                        </div>
                                    </div>
                                </div>
...
{{--                                </div>--}}
                            ...
                            <div class="form-group  ">
                                ...
                                <input type="text" name="name" id="name" autocomplete="off" title="Name must be atleast 3 characters." class="selectWanted required" required placeholder="Name">
                            ...
                            <div class="form-group  ">
                                ...
                                <input type="text" name="email" id="email" autocomplete="off" class="selectWanted" required placeholder="Eamil Address">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="mobile_no" id="mobile_no" title="Must be in valid format (03xxxxxxxxx)." autocomplete="off" class="selectWanted" required placeholder="Phone">
                            ...
                            <div class="form-row">
                                <div class="col 7" style="padding-left: 0px;">
                                   <select class="select-city-state select_Wanted1 city_id" id='city_id' name="city_id" required>
                            ...
                            <div class="col-md-6" style="margin-left: -10px;">
                                <label class="control-label_wanted">City Area &nbsp;<i class="text-danger">*</i></label>
                            </div>

                            <div class="form row col-md-6" style="padding-left: 0px;" >
                                <div class="col 6">
                                <select style="width: 531px; !important;"class="select-city-state form-control" name="city_area_id" id='city_area_id' required>
                            ...
                            <div class=" textarea1">
                                ...
                                <textarea name="comments" id="message" placeholder="Message" autocomplete="off" class="selectWanted" ></textarea>
                                <br>
                                ...
                                <!-- end form-group -->
                                <div class="buttons">
                                    <button id="submit_Btn" type="button"  class="float-right btn-lg btn-primary mb-5 mt-5" name="submit">
