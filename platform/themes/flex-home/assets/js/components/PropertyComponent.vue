                ...
                <div class="info">
                    ...
                    <p class="threemt bold500">
                        <span data-toggle="tooltip" data-placement="top" :data-original-title="__('Number of rooms')"
                            v-if="item.number_bedroom"> <i><img :src="themeUrl('images/bed.svg')" alt="icon"></i> <i
                                class="vti">{{ item.number_bedroom }}</i> </span>
                        <span data-toggle="tooltip" data-placement="top"
                            :data-original-title="__('Number of rest rooms')" v-if="item.number_bathroom"> <i><img
                                    :src="themeUrl('images/bath.svg')" alt="icon"></i> <i class="vti">{{
                                item.number_bathroom }}</i></span>
                        <span data-toggle="tooltip" data-placement="top" :data-original-title="__('Square')"
                            v-if="item.square"> <i><img :src="themeUrl('images/area.svg')" alt="icon"></i> <i
                                class="vti">{{ item.square_text }}</i> </span>
                    </p>
                </div>
            </div>
        </div>
