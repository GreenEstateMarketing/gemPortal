            ...
            <div class="col-sm-9 padtop10">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <h5>
                            <strong>{{ __('Real Estate Insights') }}</strong>
                        </h5>
...
<script>
    ...
    window.trans = {
        ...
        "Added to wishlist successfully!":
            "{{ __('Added to wishlist successfully!') }}",

        "Removed from wishlist successfully!":
            "{{ __('Removed from wishlist successfully!') }}",

        "I care about this property!!!":
            "{{ __('I care about this property!!!') }}",
